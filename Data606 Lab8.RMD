...
#Set my working directory as /Users/riteshlohiya/Desktop/CUNY/DATA606/labs/Lab8/more/
...
```{r}
load("/Users/riteshlohiya/Desktop/CUNY/DATA606/labs/Lab8/more/evals.RData")
head(evals)
summary(evals)
```
...
Answer: This is an observational study. We can rephrase the question as: Is there an association between beauty and course evaluation score?
...
One more set is of gender and rank:

```{r}
qplot(x = rank, fill = gender, data = evals, geom = "bar", position = "fill")
```

Here we can see the tenured rank has the highest representation of men about 2/3rd.
...
Nearly normal residuals: The residuals appear to be nearly normal.
Linearity: The relationship looks linear
...
score^=(3.75+0.1724)+0.074×bty_avg
score^=3.92+0.074×bty_avg
...
R has taken the rank variable and put it into 2 dummy variables to account for the three possible levels: tenure-track, tenured, and teaching.
...
The correct answer is cls_profs.
